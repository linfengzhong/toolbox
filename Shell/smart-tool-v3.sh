...
function inital_smart_tool() {
	...
	array_service_description=("Network sent" "Network receive" "CPU" "Disk free" "Disk used" "Memory" "SSH" "Service xray" "Service nginx" "Service webmin" "Service nrpe" "Service ncpa" "HTTPS" "Certificate" "TCP 5666" "TCP 5693" "TCP 9100" "Service node exporter" "Total process" )
	array_check_command=("check_ncpa_interface_sent" "check_ncpa_interface_receive" "check_ncpa_cpu" "check_ncpa_disk_free" "check_ncpa_disk_used" "check_ncpa_memory" "check_ssh" "check_ncpa_service_xray" "check_ncpa_service_nginx" "check_ncpa_service_webmin" "check_ncpa_service_nrpe" "check_ncpa_service_ncpa_listener" "check_http" "check_certificate_expires" "check_port_5666" "check_port_5693" "check_port_9100" "check_ncpa_service_node_exporter" "check_ncpa_processes")
