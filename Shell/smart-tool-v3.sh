...
function initVar() {
	...
	array_service_description=("Network" "CPU" "Disk" "Memory" "Total procedures" "SSH" "Service xray" "Service nginx" "Service webmin" "Service nrpe" "HTTPS" "Certificate" "TCP 5666" "TCP 9100" "TCP 10000" "Service node_exporter" )
