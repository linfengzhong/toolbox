...
function inital_smart_tool() {
	...
	array_service_description=("Network" "CPU" "Disk" "Memory" "SSH" "Service xray" "Service nginx" "Service webmin" "Service nrpe" "HTTPS" "Certificate" "TCP 5666" "TCP 9100" "Service node exporter" )
	array_check_command=("check_eth" "check_cpu_stats" "check_disk" "check_mem" "check_ssh" "check_xray" "check_nginx" "check_webmin" "check_nrpe" "check_http" "check_certificate_expires" "check_port_5666" "check_port_9100" "check_node_exporter" )
