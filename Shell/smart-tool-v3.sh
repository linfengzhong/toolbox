...
function initVar() {
	...
	# 自定义服务数组
	array_service_description=("CPU" "Users" "Disk usage" "Memory" "Procedures" "SSH" "Ping" "Service v2ray" "Service xray" "Service trojan.go" "Service nginx" "Service httpd" "Service v2-ui" "Service x-ui" "Service webmin" "Service docker" "Service nrpe" "Service node_exporter" "HTTP" "Certificate")
