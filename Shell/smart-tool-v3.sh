...
function initVar() {
	...
	array_service_description=("Network" "CPU" "Disk usage" "Memory" "Total procedures" "SSH" "Service xray" "Service nginx" "Service httpd" "Service webmin" "Service docker" "Service nrpe" "Service node_exporter" "HTTPS" "Certificate" "TCP 5666" "TCP 9100" "TCP 10000" )
	array_check_command=("check_eth" "check_cpu_stats" "check_disk" "check_mem" "check_total_procs" "check_ssh" "check_xray" "check_nginx" "check_httpd" "check_webmin" "check_docker" "check_nrpe" "check_node_exporter" "check_http" "check_certificate_expires" "check_port_5666" "check_port_9100" "check_port_10000" )
